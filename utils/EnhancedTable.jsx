...
import assetFetcherBF from "../utils/assetFetcherBF";
...
const rows = [
  createData(1, "Cupcake", "Akash", 3.7, 67, 4.3),
...
const headCells = [
  {
    ...
    numeric: false,
    disablePadding: true,
    label: "NFT | Owner Name",
  },
  {
    id: "calories",
    numeric: true,
    disablePadding: false,
    label: "Transaction Hash | Prepod",
  },
  {
    id: "fat",
    numeric: true,
    disablePadding: false,
    label: "Proposed Amount | NFT",
  },
  {
    id: "carbs",
    numeric: true,
    disablePadding: false,
    label: "KYC Document Details | View Mode",
  },
  {
    id: "protein",
    numeric: true,
...
export default function EnhancedTable() {
  ...
  async function handleMetadataWithBlockFrost() {
    try {
      ...
      const data = await assetFetcherBF(response.data);
      setNFTData(data);
      if (NFTData[0]) {
        NFTData.forEach((item, index) => {
          setFinaData((prevItem) => [
            ...prevItem,
            createData(
              index + 1,
      ...
      console.log("Updated finalized", finaData);
    } catch (error) {
      ...
      {loading ? (
        ...
        <Box sx={{ width: "100%", marginTop: "50px", marginBottom: "50px" }}>
          ...
          <FormControlLabel
            ...
            label="Select NFT's only after valid Viewpoints"
          />
        </Box>
      )}
    </>
